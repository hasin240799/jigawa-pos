...
const statusBody = (rowData) => {
    return <Tag value={rowData.status.toUpperCase()} severity={getSeverity(rowData.status)} />;
};
     ...
     const  sendCancelSale  = async (form)=>{
        try {
            ...
            if (response.data.success) {
                showSuccess('success',"Cancel Sale",response.data.message)
                console.log('Sales Return:', response.data);
            }else{
                showSuccess('error',"Cancel Sale",response.data.message)
                console.log('Sales Return:', response.data);
            }
