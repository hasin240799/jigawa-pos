...
const stockTemplate = (rowData)=>{
    ...
    const header = (
        <div className="flex justify-between pl-4">
          ...
          <Button type="button" icon="pi pi-file-pdf text-green-500 text-2xl" severity="warning" rounded onClick={exportPdf} data-pr-tooltip="PDF">Download Price List</Button>
