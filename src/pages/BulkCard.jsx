...
export default function BulkCard() {
 ...
 const [formData, setFormData] = useState([]);
    ...
    const sendDataToBackend = async (data) => {
        try {
            const response = await axios.post("https://api.scan-verify.com/api/card-uploads", { data });
    ...
    return (
        ...
        <div className="flex items-center justify-center lg:max-w-screen-md p-12 w-1/2 sm:w-full md:w-1/2 mx-auto">
            ...
            <h1 className=" font-bold mx-auto text-4xl place-self-start text-green-500 justify-center text-left">Upload Cards Excel File</h1>
            <Toast ref={toast} />
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="card my-5">
                                ...
                                <FileUpload
                                  ...
                                  uploadLabel='Upload Cards in Bulk'
