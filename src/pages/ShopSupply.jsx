...
export default function ShopSupply({ auth }) {
    ...
    const handleFileChange = (e) => {
     ...
     const  fetch  = async ()=>{
        try {
            const response = await axios.get('https://api.scan-verify.com/api/shop/supply', {
                headers: {
...
<h1 className='text-gray-700 font-bold text-2xl'>Shop Purchase History</h1>
