                    ...
                    <Stepper ref={stepperRef} style={{ flexBasis: '50rem' }}>
                        <StepperPanel header="Basic Info">
                            <div className="flex flex-row h-auto">
                                ...
                                <label htmlFor="role_desc" className="my-3 block font-bold text-base font-medium text-[#07074D]">
                                    Role Description
                                </label>
                                <textarea
                                    id="role_desc"
                                    ...
                                    onChange={(e)=>{handleInputChange('role_desc',e.target.value)}}
                                    className="w-full px-3 py-2 text-base text-[#229633] border rounded-md focus:outline-none focus:ring ring-[#2ad42a] focus:border-[#29ca4c]"
                                ></textarea>
                            ...
                            <div className="card flex justify-content-center w-full  my-3">
                                    <Dropdown filter={true} placeholder='Select LGA'  value={formData.lga} onChange={(e)=> {handleInputChange('lga',e.target.value) }} options={lgas} optionLabel="lga" className="w-full text-green-500 border border-green-500 px-4 py-2" />
                            </div>
                            ...
                            <div className="card flex justify-content-center w-full  mt-3 mb-6">
                                    <Dropdown filter={true} placeholder='Select Ward'  value={formData.ward} onChange={(e)=> {handleInputChange('ward',e.target.value) }} options={wardsData} optionLabel="ward" className="w-full text-green-500 border border-green-500 px-4 py-2" />
                            </div>
