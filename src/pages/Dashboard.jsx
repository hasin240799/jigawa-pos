...
const Dashboard = () => {
    ...
    <div className="container-fluid px-2 py-5 bg-white">
       {loading && <Preloader/>} {/* Show Preloader while loading */}
        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 gap-6 mx-auto justify-center items-center'>
            {items.map((item)=>{
                    return(
                        <>
                        <div className=' bg-green-200 p-4 rounded-md  border w-1/5 h-auto grid grid-cols-3 '>
        ...
        <div className=' grid grid-cols-3 gap-12 my-5 px-4 bg-white'>
        <ResponsiveContainer width="100%" height={300} className="mx-auto mb-12">
            ...
            <ResponsiveContainer width="100%" height={300} className=" mx-auto mb-5">
            <h2 className="text-2xl font-semibold text-gray-800 text-center my-4">Shops Sales Revenue</h2>
            ...
            <ResponsiveContainer width="100%" height={300} className=" mx-auto mb-12">
            <h2 className="text-2xl font-semibold text-gray-800 text-center">Sales Revenue For Last 30 Days</h2>
