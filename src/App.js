...
import SalesReturn from './pages/SaleReturn';
import AgentList from './pages/AgentList';
import CardReceipt from './pages/CardReceipt';
      ...
      <Router>
       <Layout>
        ...
        <Routes>
          ...
          <Route path="/apply-card" element={<CardRequest />} />
            ...
            <Route path="/sales/receipt-card/:id" element={<ProtectedRoute><CardReceipt /></ProtectedRoute>} />
            ...
            <Route path="/card-activation" element={<ProtectedRoute><CardActivation /></ProtectedRoute>} />
