...
import { FaBars, FaCreditCard, FaFileDownload, FaFingerprint, FaNetworkWired, FaRegEdit, FaRegistered, FaRegPaperPlane, FaUserEdit } from "react-icons/fa";
                                    ...
                                    <ul className="list-none p-0 m-0 overflow-hidden">
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <a ref={btnRef6} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
                                                            ...
                                                            <span className="font-medium">Live Shopping</span>
                                        ...
                                        <li>
                                            ...
                                            <ul className="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                <li>
                                                    <Link
                                                        to="/product/add" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><VscPackage /></i>
                                        ...
                                        <li>
                                            ...
                                            <ul className="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                <li>
                                                    <Link
                                                        to="/sales/form" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><VscPackage /></i>
                                                ...
                                                <li>
                                                    <Link
                                                        to="/sales/return" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><BiListOl /></i>
                                        ...
                                        <li>
                                            ...
                                            <ul className="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                <li>
                                                    <Link
                                                        to="/stock/add" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><VscPackage /></i>
                                                        <span className="font-medium">Stocks</span>
                                        ...
                                        <li>
                                            ...
                                            <ul className="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                <li>
                                                    <Link
                                                        to="/shops/view" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><VscPackage /></i>
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <a ref={btnRef5} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
                                                            <i className="pi pi-th-large  mr-2"></i>
                                                            <span className="font-medium">Employee Uploads</span>
                                                            <i className="pi pi-chevron-down ml-auto mr-1"></i>
                                                            <Ripple />
                                                </a>
                                            ...
                                            <ul className="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all transition-duration-400 transition-ease-in-out">
                                                <li>
                                                    <Link
                                                        to="/upload/net-salary" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><VscPackage /></i>
                                                        <span className="font-medium">Upload Salary Net</span>
                                                        <Ripple />
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link
                                                        to="/upload/repayment" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><BiListOl /></i>
                                                        <span className="font-medium">Upload Repayments</span>
                                                        <Ripple />
                                                    </Link>
                                                </li>
                                                ...
                                                <li>
                                                    <Link
                                                        to="/loan/repay" // Update the path as per your routing setup
                                                        className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                                    >
                                                        <i className="mr-2"><FaFileDownload /></i>
                                                        <span className="font-medium">Download Loan<Tag severity="success" className='' value="New"></Tag></span>
                                                        <Ripple />
                                                    </Link>
                                                </li>
                                        ...
                                        <li>
                                            <Link
                                                to="/users/add" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                        ...
                                        <li>
                                            <Link
                                                to="/agent-list" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className="pi pi-users mr-2"></i>
                                                <span className="font-medium">User Agents </span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link
                                                to="/apply-card" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className=" mr-2"><FaRegPaperPlane/></i>
                                                <span className="font-medium">Card Request </span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link
                                                to="/bulk-cards" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className=" mr-2"><FaCreditCard/></i>
                                                <span className="font-medium">Card Uploads</span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link
                                                to="/card-activation" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className=" mr-2">< FaFingerprint/></i>
                                                <span className="font-medium">Card Activation</span>
                                                <Ripple />
                                            </Link>
                                        </li>
