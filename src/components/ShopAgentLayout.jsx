                    ...
                    <div className="flex flex-column h-full">
                        <div className="flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0">
                         ...
                         <span className=' mx-auto font-bold text-black font-sans'>{name}</span>
                            <span className=' mx-auto mb-3 font-bold '>SALE AGENT</span>
                                    ...
                                    <ul className="list-none p-0 m-0 overflow-hidden">
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Change Password <Tag severity="info" className='w-3' value="Soon"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
...
export default ShopAgentLayout;
