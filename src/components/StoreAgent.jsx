...
import { BiListOl, BiMenu, BiSolidReport } from 'react-icons/bi';
            ...
            <div className="min-h-screen flex relative lg:static surface-ground">
                <div id="app-sidebar-2" className="" style={{ width: '280px' }}>
                    <div className="flex flex-column h-full">
                        ...
                        <span className=' mx-auto mb-3 font-bold '>SEMA STORE AGENT</span>
                                    ...
                                    <ul className="list-none p-0 m-0 overflow-hidden">
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Verify Customer <Tag severity="success" className='' value="New"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Change Password <Tag severity="success" className='' value="New"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
...
export default StoreAgentLayout;
