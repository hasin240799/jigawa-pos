...
import { BiAnalyse, BiListOl, BiMenu, BiSolidReport, BiSpa, BiTv } from 'react-icons/bi';
            ...
            <div className="min-h-screen flex relative lg:static surface-ground">
                <div id="app-sidebar-2" className="" style={{ width: '280px' }}>
                    <div className="flex flex-column h-full">
                        ...
                        <span className=' mx-auto  font-bold '>{name}</span>
                        <span className=' mx-auto  font-bold '>Finance | Admin</span>
                                    ...
                                    <li>
                                        ...
                                        {/* <li>
                                            ...
                                            >
                                                ...
                                                <a ref={btnRef2} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
                                                            ...
                                                            <span className="font-medium">Sales <Tag severity="success" className='' value="New"></Tag></span>
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Sales History <Tag severity="success" className='' value="New"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link
                                                to="/store/stocks" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className="pi pi-shopping-bag mr-2"></i>
                                                <span className="font-medium">Main Store stocks </span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        <li>
                                            <Link
                                                to="/shops/stocks" // Update the path as per your routing setup
                                                className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full"
                                            >
                                                <i className="pi pi-shopping-bag mr-2"></i>
                                                <span className="font-medium">Shop stocks </span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Verify Receipt <Tag severity="success" className='' value="New"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        <li>
                                            ...
                                            >
                                                <i className="pi pi-verified mr-2"></i>
                                                <span className="font-medium">View Picked Up <Tag severity="success" className='' value="New"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            >
                                               ...
                                               <BiSolidReport  className='mr-2' />
                                                <span className="font-medium">Reports <Tag severity="info" className='' value=" Soon"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Settings <Tag severity="info" className='' value=" Soon"></Tag></span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        <li>
