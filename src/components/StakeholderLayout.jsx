...
import { BiAnalyse, BiListOl, BiMenu, BiTv } from 'react-icons/bi';
...
import { FaBars, FaBroadcastTower, FaDatabase, FaHistory } from "react-icons/fa";
            ...
            <div className="min-h-screen flex relative lg:static surface-ground">
                <div id="app-sidebar-2" className="" style={{ width: '280px' }}>
                    <div className="flex flex-column h-full">
                        ...
                        <span className=' mx-auto  font-bold '>Executives</span>
                                    ...
                                    <li>
                                            ...
                                            >
                                                ...
                                                <a ref={btnRef1} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
                                                            <i className="text-green-500  mr-2"> <FaHistory/></i>
                                                            <span className="font-medium text-green-500">Reports</span>
                                                            <i className="pi pi-chevron-down ml-auto mr-1"></i>
                                                            <Ripple />
                                                </a>
                                        ...
                                        <li>
                                            ...
                                            >
                                                <i className="pi pi-shopping-bag mr-2"></i>
                                                <span className="font-medium">Shop Purchases</span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">Store Supplies </span>
                                                <Ripple />
                                            </Link>
                                        </li>
                                        </ul>
                                    ...
                                    <li>
                                            ...
                                            >
                                                ...
                                                <a ref={btnRef2} className="p-ripple flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors w-full">
                                                            <i className="text-green-500  mr-2"> <FaDatabase/></i>
                                                            <span className="font-medium text-green-500">Stocks</span>
                                                            <i className="pi pi-chevron-down ml-auto mr-1"></i>
                                                            <Ripple />
                                                </a>
