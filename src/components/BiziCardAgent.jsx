...
import { FaBars, FaCreditCard, FaMoneyBill, FaNetworkWired } from "react-icons/fa";
import Logo from './Logo';
import { Tag } from 'primereact/tag';
import { useNavigate } from 'react-router-dom';
import { FaRegCreditCard } from 'react-icons/fa6';
const BiziCardAgentLayout = () => {
            ...
            <div className="min-h-screen flex relative lg:static surface-ground">
                <div id="app-sidebar-2" className="" style={{ width: '280px' }}>
                    <div className="flex flex-column h-full">
                        ...
                        <span className=' mx-auto mb-3 font-bold '>Bizipay Card Agent User</span>
...
export default BiziCardAgentLayout;
